...
public class TallentajaTest {
    ...
    public void testaaViitteenPoistoa() throws Exception {
        ...
        Article article3 = new Article("article","K00", "Karl, D.", "Funktion und Bedeutung einer weisen Frau im alten Ägypten", "2000", "JOURNAL", null,null,null);
    ...
    public void testaaViitteenTallennustaTallentajanKautta() throws Exception {
        ...
        Article article2 = new Article("article","K00", "Karl, D.", "Funktion und Bedeutung einer weisen Frau im alten Ägypten", "2000", "JOURNAL",null,null,null);
