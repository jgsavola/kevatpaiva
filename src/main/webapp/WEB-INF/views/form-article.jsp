...
<body>
    ...
    <fieldset>
        <legend>Lisää artikkeli</legend>

        <p>${message}</p>

        <fieldset>
            <legend>Pakolliset</legend>

        <label for="id">ID</label>
        <input name="id" id="id" type="text" value="${id}"/>    

        <label for="author" title="Recognized structures:
        [First von Last] or 
        [von Last, First] or 
        [von Last, Jr ,First]">Kirjoittaja (author)</label>
        <input name="author" id="author" type="text" value="${author}" title="author" />
